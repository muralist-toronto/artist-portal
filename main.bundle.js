...
var MyPieceComponent = (function () {
    ...
    MyPieceComponent.prototype.savePieceDetails = function () {
        console.log(this.pieceObj, this.artistUid, this.pieceUid);
    ...
    MyPieceComponent.prototype.getPieceDetailsDBCall = function (authUid, pieceUid) {
        ...
        pieceRef.subscribe(function (piece) {
            var recdPiece = piece.val();
            recdPiece.price = parseInt(recdPiece.price);
            _this.pieceObj = recdPiece;
            // get img
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__my_pieces_new_piece_new_piece_component__ = __webpack_require__("../../../../../src/app/ui/my-pieces/new-piece/new-piece.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__my_pieces_new_piece_details_new_piece_details_component__ = __webpack_require__("../../../../../src/app/ui/my-pieces/new-piece-details/new-piece-details.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__purchase_requests_purchase_requests_component__ = __webpack_require__("../../../../../src/app/ui/purchase-requests/purchase-requests.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__my_pieces_my_piece_my_piece_component__ = __webpack_require__("../../../../../src/app/ui/my-pieces/my-piece/my-piece.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    UiModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__my_pieces_my_piece_my_piece_component__["a" /* MyPieceComponent */],
                __WEBPACK_IMPORTED_MODULE_16__my_pieces_new_piece_new_piece_component__["a" /* NewPieceComponent */],
                __WEBPACK_IMPORTED_MODULE_17__my_pieces_new_piece_details_new_piece_details_component__["a" /* NewPieceDetailsComponent */],
                __WEBPACK_IMPORTED_MODULE_18__purchase_requests_purchase_requests_component__["a" /* PurchaseRequestsComponent */],
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_11__top_nav_top_nav_component__["a" /* TopNavComponent */],
                __WEBPACK_IMPORTED_MODULE_12__footer_nav_footer_nav_component__["a" /* FooterNavComponent */],
...
var WebService = (function () {
    function WebService(_http) {
        this._http = _http;
        this.baseUrl = 'https://us-central1-art-auction-2ef27.cloudfunctions.net';
    }
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyBBj2d_MPplAH1ngU43N5tzIc72AhoI0dA",
        authDomain: "art-auction-2ef27.firebaseapp.com",
        databaseURL: "https://art-auction-2ef27.firebaseio.com",
        projectId: "art-auction-2ef27",
        storageBucket: "art-auction-2ef27.appspot.com",
        messagingSenderId: "291540216074"
    },
};
